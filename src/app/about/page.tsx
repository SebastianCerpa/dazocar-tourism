          ...
          <section className="mission-vision">
            <div className="section-container">
              ...
              <p>
                ...
                diversity and beauty of Chile to the world. We strive to promote
                sustainable tourism that respects local communities and
                preserves the natural environment. Through authentic experiences
                and responsible travel, we aim to create meaningful connections
                between visitors and Chile rich culture and landscapes.
              </p>
            </div>
          </section>
